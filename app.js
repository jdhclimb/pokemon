  ...
  const QUESTIONS = [
    {
      ...
      options: [
        { key: "A", text: "수상하게 생긴 거(누워서 시작, 발금지 등)", points: [["gengar", 2], ["pikachu", 1], ["togepi", 1]] },
        { key: "B", text: "할 만하게 생긴 재밌는 거", points: [ ["snorlax", 2], ["eevee", 1], ["ditto", 1], ["lucario", 1]] },
        { key: "C", text: "개간지 다이나믹", points: [["charizard", 2], ["dragonite", 1],["mewtwo", 1], ["lucario", -3],] },
      ],
    },
    {
      title: "Q2. 조금 어려워 보이는 문제 처음 붙어볼 때",
      options: [
        { key: "A", text: "카탈로그/남들 푸는 거 한 번 보고 붙어본다", points: [["ditto", 2], ["togepi", 2]] },
        { key: "B", text: "일단 붙어본다", points: [["charizard", 2], ["mewtwo", 1], ["pikachu", 1], ["snorlax", 1],["magikarp", 1], ["gengar", 1]] },
        { key: "C", text: "혼자 루파 열심히 해보고 붙어본다", points: [["eevee", 2],["dragonite", 1],["lucario", 1]] },
      ],
    },
    {
      title: "Q3. 제일 잘 될 때는?",
      options: [
        { key: "A", text: "사람들이 나이스 외쳐줄 때", points: [["pikachu", 2], ["togepi", 1], ["eevee", 1],["charizard", 1]] },
        { key: "B", text: "혼자 집중해서 풀 수 있을 때", points: [["rayquaza", 2],["lucario", 1], ["dragonite", 1], ["mewtwo", 2], ["pikachu", -1]] },
        { key: "C", text: "옆에서 베타 알려주는 사람이 있을 때", points: [["ditto", 2]] },
        { key: "D", text: "몰?루? 갑자기 될 때 있음", points: [["wynaut", 2], ["charizard", 1],["magikarp", 1], ["snorlax", 1], ["gengar", 1]] },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        { key: "A", text: "때려친다", points: [["snorlax", 2], ["eevee", 1], ["magikarp", 1]] },
        { key: "B", text: "샤갈! 오늘은 너다. 될 때까지 ㄱㄱ", points: [["mewtwo", 2],["charizard", 1]] },
        { key: "C", text: "30트...해본 적 없는데?", points: [["rayquaza", 2], ["togepi", 1], ["magikarp", 1]] },
        { key: "D", text: "제발 누가 알려주면 좋겠다", points: [["ditto", 2], ["lucario", 1], ["dragonite", 1]] },
      ],
    },
    {
      ...
      options: [
        ...
        { key: "B", text: "쉬엄쉬엄~ 나이스~ 응원도 하고~", points: [["snorlax", 2], ["pikachu", 1], ["dragonite", 2],["rayquaza", -1],] },
        { key: "C", text: "쉬어야지 암장을 왜 가", points: [["magikarp", 2], ["togepi", 2], ["eevee", 1], ["ditto", 1], ["rayquaza", -1], ["mewtwo", -1]] },
      ],
    },
    {
      title: "Q8. 가장 기분 좋은 순간은?",
      options: [
        { key: "A", text: "존버하던 문제 결국 깼을 때", points: [["mewtwo", 2], ["eevee", 2], ["charizard", 1], ["ditto", 1]] },
        { key: "B", text: "빡센 문제 완등하고 숨 찰 때", points: [["rayquaza", 2], ["lucario", 1]] },
        { key: "C", text: "다른 사람이 내가 알려준 무브로 깼을 때", points: [["dragonite", 5], ["wynaut", 1]] },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        { key: "B", text: "덕분에 풀었다 고마워!", points: [["dragonite", 3], ["rayquaza", 1],] },
        { key: "C", text: "실력 왤케 늘었어", points: [["eevee", 2],["mewtwo", 1], ["charizard", 1], ] },
        { key: "D", text: "저게 왜 되누", points: [["gengar", 2],["lucario", 1], ] },
      ],
    },
    {
      title: "Q11. 가장 빡치는 순간",
